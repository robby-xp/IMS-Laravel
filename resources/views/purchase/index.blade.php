...
@section('content')
<div class="container">
	<a href="#" class="btn add-new" role="button" data-toggle="modal" data-target="#newPO">
	    <span class="glyphicon glyphicon-plus-sign"></span>
	    Tambah Order Pembelian</a>
	<!--Start PO List-->
	        ...
	        <div class="row">
	            <div class="col-xs-5">
	                <div style="margin-top: -5px;">
	                    <h3><span class="glyphicon glyphicon-list"></span> Daftar Order Pembelian</h3>
	                </div>
	            </div>
	            <div class="col-xs-7">
	                <form class="navbar-form hidden-xs navbar-right form-inline" role="form" method="get" id="search-form-hidden-xs" name="search-form">
	                    <div class="form-group" style="margin-top: 5px;">
	                        <input type="text" class="form-control" placeholder="cari order pembelian" id="searchPO" name="search" style="width: 300px;">
    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form" method="get" id="poEditorial" name="frmPOEditorial">
                    <div class="container-fluid" style="margin-left: 0px; margin-right: 0px;">
                        <div class="row" style="padding-bottom: 15px;">
                            <div class="col-xs-4" style="padding-right: 0px; width: auto;">
                                <label class="editorial-label">Kode Order Pembelian</label>
                            </div>
                            ...
                            <div class="col-xs-7" style="padding-left: 0px; width: 355px;">
                                <input class="form-control" id="poCode" type="text" placeholder="auto" disabled>
                            </div>
                        </div>
                        <div class="row" style="padding-bottom: 15px;">
                            <div class="col-xs-4" style="padding-right: 0px; width: auto;">
                                <label class="editorial-label">Nama Pemasok</label>
                            </div>
                            <div class="col-xs-1" style="padding-left: 50px; padding-right: 7px; width: auto;">
                                <label class="editorial-label">:</label>
                            </div>
                            <div class="col-xs-7" style="padding-left: 0px; width: 355px;">
                                <input class="form-control" id="poVendor" type="text" placeholder="nama pemasok">
                            </div>
                        </div>
                        <div class="row" style="padding-bottom: 15px;">
                            <div class="col-xs-4" style="padding-right: 0px; width: auto;">
                                <label class="editorial-label">Tgl Pembelian</label>
                            </div>
                            <div class="col-xs-1" style="padding-left: 55px; padding-right: 7px; width: auto;">
                                <label class="editorial-label">:</label>
                            </div>
                            <div class="col-xs-7" style="padding-left: 0px; width: 355px;">
                                <div class='input-group date' id='poDate'>
                            ...
                            <div class="panel-footer">
                                <div class="row">
                                    <div class="col-xs-5" style="padding-right: 0px; width: auto;">
                                        <label class="editorial-label">Total Pembelian Barang</label>
                                    </div>
